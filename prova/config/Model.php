<?php
  class Model {
    ...
    public static function insert(Array $data, $table): bool {
      self::setTable($table);
    ...
    public static function update(Array $data, Array $conditions, $table): bool {
      self::setTable($table);
    ...
    public static function delete(Array $data, $table): bool {
      self::setTable($table);
